 ...
 */
export const componentNames: { [s: string]: string; } =  util.keyMirror(
    "IMAGE_LOADER",
    "CROPPER",
    "FLIP",
    "ROTATION",
 ...
 * @type {Object.<string, string>}
 */
export const commandNames: { [s: string]: string; } = {
 ...
 * @type {Object.<string, string>}
 */
export const drawingModes: { [s: string]: string; } = util.keyMirror(
    "NORMAL",
    "CROPPER",
    "FREE_DRAWING",
    "LINE_DRAWING",
 ...
 */
export const keyCodes: { [s: string]: number; } = {
    Z: 90,
    Y: 89,
    SHIFT: 16,
    BACKSPACE: 8,
 ...
 */
export const fObjectOptions: { [s: string]: Object; } = {
    SELECTION_STYLE: {
        borderColor: "red",
        cornerColor: "green",
        cornerSize: 10,
 ...
 * @type {Object.<string, string>}
 */
export const rejectMessages: { [s: string]: string; } = {
 ...
 * @type {Object.<string, string>}
 */
export const defaultIconPath: { [s: string]: string; } = {

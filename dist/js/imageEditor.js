...
var keyCodes = consts.keyCodes, rejectMessages = consts.rejectMessages;
var isUndefined = tui_code_snippet_1.default.isUndefined, forEach = tui_code_snippet_1.default.forEach, CustomEvents = tui_code_snippet_1.default.CustomEvents;
/**
 * Image editor
 * @class
...
var ImageEditor = /** @class */ (function () {
    function ImageEditor(wrapper, options) {
        options = tui_code_snippet_1.default.extend({
            includeUI: false,
        ...
        if (options.includeUI) {
            this.ui = new ui_1.default(wrapper, options.includeUI, this.getActions());
         ...
         * @private
         */
        this._invoker = new invoker_1.default();
        /**
         * Graphics instance
         * @type {Graphics}
         * @private
         */
        this._graphics = new graphics_1.default(this.ui ? this.ui.getEditorArea() : wrapper, {
     ...
     * @private
     */
    ImageEditor.prototype._setSelectionStyle = function (selectionStyle, _a) {
        var applyCropSelectionStyle = _a.applyCropSelectionStyle, applyGroupSelectionStyle = _a.applyGroupSelectionStyle;
        if (selectionStyle) {
     ...
     * @private
     */
    ImageEditor.prototype._attachInvokerEvents = function () {
        var UNDO_STACK_CHANGED = events.UNDO_STACK_CHANGED, REDO_STACK_CHANGED = events.REDO_STACK_CHANGED;
        /**
     ...
     * @private
     */
    ImageEditor.prototype._attachGraphicsEvents = function () {
        this._graphics.on({
     ...
     * @private
     */
    ImageEditor.prototype._attachDomEvents = function () {
     ...
     * @private
     */
    ImageEditor.prototype._detachDomEvents = function () {
        // ImageEditor supports IE 9 higher
    ...
    ImageEditor.prototype._onKeyDown = function (e) {
     ...
     */
    ImageEditor.prototype.removeActiveObject = function () {
        var activeObject = this._graphics.getActiveObject();
        var activeObjectGroup = this._graphics.getActiveGroupObject();
     ...
     * @private
     */
    ImageEditor.prototype._removeObjectStream = function (targetObjects) {
        var _this = this;
        if (!targetObjects.length) {
            return true;
        }
        var targetObject = targetObjects.pop();
        return this.removeObject(this._graphics.getObjectId(targetObject)).then(function () { return (_this._removeObjectStream(targetObjects)); });
    };
    /**
     ...
     * @private
     */
    ImageEditor.prototype._onMouseDown = function (event, originPointer) {
        /**
     ...
     * @private
     */
    ImageEditor.prototype._pushAddObjectCommand = function (obj) {
        var command = command_1.default.create(commands.ADD_OBJECT, this._graphics, obj);
     ...
     * @private
     */
    ImageEditor.prototype._onObjectActivated = function (props) {
        /**
     ...
     * @private
     */
    ImageEditor.prototype._onObjectMoved = function (props) {
        /**
     ...
     * @private
     */
    ImageEditor.prototype._onObjectScaled = function (props) {
        /**
     ...
     * }
     */
    ImageEditor.prototype.getDrawingMode = function () {
     ...
     */
    ImageEditor.prototype.clearObjects = function () {
     ...
     */
    ImageEditor.prototype.deactivateAll = function () {
     ...
     */
    ImageEditor.prototype.discardSelection = function () {
     ...
     */
    ImageEditor.prototype.changeSelectableAll = function (selectable) {
     ...
     * @private
     */
    ImageEditor.prototype.execute = function (commandName) {
        var args = [];
        ...
        return (_a = this._invoker).execute.apply(_a, [commandName].concat(theArgs));
        var _a;
    };
    /**
     * Undo
     ...
     * });
     */
    ImageEditor.prototype.loadImageFromFile = function (imgFile, imageName) {
        if (!imgFile) {
            return promise_1.default.reject(rejectMessages.invalidParameters);
        }
     ...
     * });
     */
    ImageEditor.prototype.loadImageFromURL = function (url, imageName) {
        if (!imageName || !url) {
            return promise_1.default.reject(rejectMessages.invalidParameters);
        }
     ...
     * });
     */
    ImageEditor.prototype.addImageObject = function (imgUrl) {
        if (!imgUrl) {
            return promise_1.default.reject(rejectMessages.invalidParameters);
        }
     ...
     * });
     */
    ImageEditor.prototype.startDrawingMode = function (mode, option) {
     ...
     * imageEditor.stopDrawingMode();
     */
    ImageEditor.prototype.stopDrawingMode = function () {
     ...
     */
    ImageEditor.prototype.crop = function (rect) {
     ...
     */
    ImageEditor.prototype.getCropzoneRect = function () {
     ...
     * @returns {Object}  {{left: number, top: number, width: number, height: number}} rect
     */
    ImageEditor.prototype.setCropzoneRect = function (mode) {
     ...
     * @private
     */
    ImageEditor.prototype._flip = function (type) {
     ...
     * });
     */
    ImageEditor.prototype.flipX = function () {
     ...
     * });
     */
    ImageEditor.prototype.flipY = function () {
     ...
     * });;
     */
    ImageEditor.prototype.resetFlip = function () {
     ...
     * @private
     */
    ImageEditor.prototype._rotate = function (type, angle) {
     ...
     * });
     */
    ImageEditor.prototype.setAngle = function (angle) {
     ...
     * });
     */
    ImageEditor.prototype.setBrush = function (option) {
     ...
     * });
     */
    ImageEditor.prototype.setDrawingShape = function (type, options) {
     ...
     * });
     */
    ImageEditor.prototype.addShape = function (type, options) {
        options = options || {};
     ...
     * });
     */
    ImageEditor.prototype.changeShape = function (id, options) {
     ...
     * });
     */
    ImageEditor.prototype.addText = function (text, options) {
        text = text || '';
        options = options || {};
     ...
     */
    ImageEditor.prototype.changeText = function (id, text) {
        text = text || '';
     ...
     * });
     */
    ImageEditor.prototype.changeTextStyle = function (id, styleObj) {
     ...
     * @private
     */
    ImageEditor.prototype._changeActivateMode = function (type) {
     ...
     * @private
     */
    ImageEditor.prototype._onTextChanged = function (objectProps) {
     ...
     * @private
     */
    ImageEditor.prototype._onIconCreateResize = function (originPointer) {
     ...
     * @private
     */
    ImageEditor.prototype._onIconCreateEnd = function (originPointer) {
     ...
     * @private
     */
    ImageEditor.prototype._onTextEditing = function () {
        /**
     ...
     * @private
     */
    ImageEditor.prototype._onAddText = function (event) {
        /**
     ...
     * @private
     */
    ImageEditor.prototype._onAddObject = function (objectProps) {
     ...
     * @private
     */
    ImageEditor.prototype._onAddObjectAfter = function (objectProps) {
     ...
     * @private
     */
    ImageEditor.prototype._selectionCleared = function () {
     ...
     * @private
     */
    ImageEditor.prototype._selectionCreated = function (eventTarget) {
     ...
     * });
     */
    ImageEditor.prototype.registerIcons = function (infos) {
     ...
     */
    ImageEditor.prototype.changeCursor = function (cursorType) {
     ...
     * });
     */
    ImageEditor.prototype.addIcon = function (type, options) {
        options = options || {};
        this._setPositions(options);
     ...
     */
    ImageEditor.prototype.changeIconColor = function (id, color) {
     ...
     */
    ImageEditor.prototype.removeObject = function (id) {
     ...
     */
    ImageEditor.prototype.hasFilter = function (type) {
     ...
     * });
     */
    ImageEditor.prototype.removeFilter = function (type) {
     ...
     * });;
     */
    ImageEditor.prototype.applyFilter = function (type, options) {
     ...
     * });
     */
    ImageEditor.prototype.toDataURL = function (options) {
     ...
     */
    ImageEditor.prototype.getImageName = function () {
     ...
     */
    ImageEditor.prototype.clearUndoStack = function () {
     ...
     */
    ImageEditor.prototype.clearRedoStack = function () {
     ...
     */
    ImageEditor.prototype.isEmptyUndoStack = function () {
     ...
     */
    ImageEditor.prototype.isEmptyRedoStack = function () {
     ...
     * @returns {Promise}
     */
    ImageEditor.prototype.resizeCanvasDimension = function (dimension) {
        if (!dimension) {
            return promise_1.default.reject(rejectMessages.invalidParameters);
        }
     ...
     * @private
     */
    ImageEditor.prototype._setPositions = function (options) {
     ...
     * });
     */
    ImageEditor.prototype.setObjectProperties = function (id, keyValue) {
     ...
     * });
     */
    ImageEditor.prototype.setObjectPropertiesQuietly = function (id, keyValue) {
     ...
     * console.log(props);
     */
    ImageEditor.prototype.getObjectProperties = function (id, keys) {
     ...
     */
    ImageEditor.prototype.getCanvasSize = function () {
     ...
     */
    ImageEditor.prototype.getObjectPosition = function (id, originX, originY) {
     ...
     * });
     */
    ImageEditor.prototype.setObjectPosition = function (id, posInfo) {
        return this.execute(commands.SET_OBJECT_POSITION, id, posInfo);
    };
    return ImageEditor;
}());
action_1.default.mixin(ImageEditor);

 ...
 */
exports.componentNames = util.keyMirror("IMAGE_LOADER", "CROPPER", "FLIP", "ROTATION", "FREE_DRAWING", "LINE", "TEXT", "ICON", "FILTER", "SHAPE");
/**
 * Command names
 * @type {Object.<string, string>}
 */
 ...
 * @type {Object.<string, string>}
 */
exports.drawingModes = util.keyMirror("NORMAL", "CROPPER", "FREE_DRAWING", "LINE_DRAWING", "TEXT", "SHAPE");
/**
 * Shortcut key values
...
exports.defaultRotateRangeValus = {
    realTimeEvent: true,
    min: -360,
    max: 360,
    value: 0
};
exports.defaultDrawRangeValus = {
    min: 5,
    max: 30,
    value: 12
};
exports.defaultShapeStrokeValus = {
    realTimeEvent: false,
    min: 2,
    max: 300,
    value: 3
};
exports.defaultTextRangeValus = {
    realTimeEvent: true,
    min: 10,
    max: 100,
    value: 50
};
exports.defaultFilterRangeValus = {
    tintOpacityRange: {
        min: 0,
        max: 1,
        value: 0.7

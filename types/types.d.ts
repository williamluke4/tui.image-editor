declare module tui {
    ...
    interface getCroppedImageData_cropRect {
        /**
         * left position
         */
        left: Number;
    ...
    interface startDrawingMode_option {
        /**
         * brush width
         */
        width: Number;
    ...
    interface setDrawingShape_options {
        /**
         * Shape foreground color (ex: '#fff', 'transparent')
         */
        fill: string;
    ...
    interface registerPaths_pathInfos {
        /**
         * key
         */
        key: string;
    ...
    interface setObjectProperties_props {
        /**
         * Color
         */
        fill: string;
    ...
    interface setObjectPosition_posInfo {
        /**
         * x position
         */
        x: number;
    ...
    class ImageEditor {
         ...
         */
        constructor(wrapper: string | any | HTMLElement, options?: undefined_options);
         ...
         * @returns
         */
        crop(rect: crop_rect): Promise<void>;
         ...
         * @returns
         */
        changeShape(id: number, options?: changeShape_options): Promise<void>;
         ...
         * @returns
         */
        addText(text: string, options?: addText_options): Promise<void>;
         ...
         * @returns
         */
        changeTextStyle(id: number, styleObj?: changeTextStyle_styleObj): Promise<void>;
         ...
         * @returns
         */
        resizeCanvasDimension(dimension: Object): Promise<void>;
         ...
         * @returns
         */
        setObjectProperties(id: number, keyValue: Object): Promise<void>;
         ...
         * @returns
         */
        setObjectPosition(id: number, posInfo: setObjectPosition_posInfo): Promise<void>;

    }

    interface undefined_options {
        /**
    ...
    interface changeTextStyle_styleObj {
        /**
         * Color
         */
        fill: string;
    ...
    class Ui {
         ...
         */
        constructor(element: string | any | HTMLElement, options: undefined_options, actions: any);
    ...
    interface resizeEditor_resizeInfo {
        /**
